  ...
  return (
    <div className="flex flex-col my-20">
      <div className="text-center flex flex-col gap-5">
        ...
        <h1 className="text-[#666666] mx-48 text-sm">
          Deep dive into emerging markets with our reports on markets, channels,
          <br /> Healthcare practioners, Health Care Ecosystem & Patients 
          <br />
          has context menu
        </h1>
      </div>

      <div className="flex flex-row  gap-5 xl:px-20 2xl:px-36 items-center">
